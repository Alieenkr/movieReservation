...
<body>
    	...
    	<div class="container" style="width:500px">
      	<form class="form-signin" method="post" action="movie_update.jsp" style="margin-center">
        	<br>
        	<br>
        	<h2 class="form-signin-heading"> 영화 수정 </h2>
        		<br>
        		<label for="inputId" class="sr-only">ID</label>
        		<input type="number" name="m_id" id="id" class="form-control" placeholder="영화 아이디는 변경할 수 없습니다." style="width:300px" autofocus>
       			<br>
       			<label for="inputTitle" class="sr-only">title</label>
        		<input type="text" name="m_title" id="title" class="form-control" placeholder="제목"  style="width:300px" >
        		<br>
        		<label for="inputDirec" class="sr-only">direc</label>
        		<input type="text" name="m_direc" id="direc" class="form-control" placeholder="영화 감독" style="width:300px" >
       			<br>
        		...
        		<button class="btn btn-lg btn-primary btn-block" type="submit" style="width:300px" > 수정하기  </button>
       </form>
	   </div> <!-- /container -->
</body>
</html>