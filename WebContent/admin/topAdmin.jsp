      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="topAdmin.jsp"> 메인 </a></li>
            <li><a href="admin_member.jsp"> 회원관리 </a></li>
            <li><a href="admin_cinema.jsp"> 영화관관리 </a></li>
             <li><a href="admin_screen.jsp"> 상영관관리 </a></li>
             <li><a href="admin_showing.jsp"> 상영관리 </a></li>
             <li><a href="admin_movie.jsp"> 영화관리  </a></li>
             <li><a href="admin_ticket.jsp"> 티켓관리 </a></li>
             </ul>
           ...
           <ul class="nav navbar-nav">  
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="../adminlogin.jsp"> 관리자 로그인 </a></li>
                <li><a href="../home.jsp"> 회원 모드 </a></li>
                </ul>
             </li>
           </ul>
<%
